    ...
    <section>
        <div class="container">
            <ul class="list-unstyled">
                <li class="d-md-inline d-block p-3"><a class="btn" href="{{route('week1')}}"
                        role="button">Week 1</a>
                </li>
                <li class="d-md-inline d-block p-3"><a class="btn" href="{{route('week2')}}"
                        role="button">Week 2</a>
                </li>
                <li class="d-md-inline d-block p-3"><a class="btn" href="{{route('week3')}}"
                        role="button">Week 3</a>
                </li>
                <li class="d-md-inline d-block p-3"><a class="btn" href="{{route('week4')}}"
                        role="button">Week 4</a>
                </li>
                <li class="d-md-inline d-block p-3"><a class="btn" href="{{route('week5')}}"
                        role="button">Week 5</a>
                </li>
                <li class="d-md-inline d-block p-3"><a class="btn" href="{{route('week6')}}"
                        role="button">Week 6</a>
                </li>
            </ul>
        </div>
